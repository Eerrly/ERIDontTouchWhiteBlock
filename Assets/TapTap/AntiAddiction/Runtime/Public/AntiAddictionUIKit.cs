...
namespace TapTap.AntiAddiction
{
    ...
    public static class AntiAddictionUIKit
    {
        ...
        private static IAntiAddictionJob CreateJob(bool isNewJob)
        {
            ...
            {
                var result = Activator.CreateInstance(((IEnumerable<Assembly>) AppDomain.CurrentDomain.GetAssemblies())
                    .Where((Func<Assembly, bool>) (asssembly => asssembly.GetName().FullName.StartsWith("TapTap.AntiAddiction.Mobile.Runtime")))
                    .SelectMany<Assembly, System.Type>((Func<Assembly, IEnumerable<System.Type>>) (assembly => (IEnumerable<System.Type>) assembly.GetTypes()))
                    .SingleOrDefault<System.Type>((Func<System.Type, bool>) (clazz => typeof(IAntiAddictionJob).IsAssignableFrom(clazz) && clazz.IsClass 
